...
def generate_launch_description():
    ...
    moveit_simple_controllers_yaml = load_yaml('ar3_moveit_config', 'config', 'ar3_controllers.yaml')
    moveit_controllers = {
    ...
    rviz_config_file = os.path.join(get_package_share_directory('ar3_moveit_config'), 'rviz', 'moveit.rviz')
    rviz_node = Node(
        package="rviz2",
        executable="rviz2",
        name="rviz2",
